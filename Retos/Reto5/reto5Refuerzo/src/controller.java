...
public class controller {
    ...
    void addMedicButtonClick(ActionEvent event) {
        ...
        || epsTextField.getText().isEmpty() || mClassificationTextField.getText().isEmpty() || mTreatmentTextField.getText().isEmpty()) {
            ...
            try {
                String name = pNameTextField.getText(); //  OK Aqui debe btener el texto de la variable mNameTextField
                String id = mIDTextField.getText();
                int age = Integer.parseInt(mAgeTextField.getText());
                String city = mCityTextField.getText(); // OK Aqui  debe btener el texto de la variable mCityTextField
                ...
                Medic.saveMedic(name,id,age,city,eps,classification,treatment); // OK Aqui debe enviar como parametro las variables previamente definidas
