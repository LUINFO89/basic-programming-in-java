...
public class CopiaReto1 {
    ...
    public static void main(String[] args) throws Exception {
        ...
        if ((prom1 < prom2 )&&( prom1 < prom3)){System.out.println("");}
        if ((prom2 < prom1 )&&( prom2 < prom3)){System.out.println("");}
        if ((prom3 < prom1 )&&( prom3 < prom2)){System.out.println("");}

        //¿Cuál es el estudiante con el mejor desempeño para la materia historia?
        if (mayorest == 1){System.out.println("");}
        if (mayorest == 2){System.out.println("");}
        if (mayorest == 3){System.out.println("");}
        if (mayorest == 4){System.out.println("");}
        if (mayorest == 5){System.out.println("");}
        if (mayorest == 6){System.out.println("");}
